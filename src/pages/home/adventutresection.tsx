...
const AdventureSection = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6">
      <section className="bg-[#0d1d18] rounded-lg text-white py-10 mt-10 px-4">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-center items-start gap-10">
          ...
          <div
            ...
            data-aos="fade-up"
          >
            <div className="text-gray-900 bg-[#fed42a] rounded-full w-20 h-20 text-4xl flex items-center justify-center shadow-lg">
              {activeTopic.icon}
            </div>
            <h2 className="text-3xl md:text-4xl font-bold leading-tight text-[#fed42a]">
              Discover real thrills & make{" "}
              <span className="text-white">memories that last forever</span>
            </h2>
